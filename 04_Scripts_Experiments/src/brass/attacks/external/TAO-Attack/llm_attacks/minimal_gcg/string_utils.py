...
class SuffixManager:
    ...
    def get_prompt(self, adv_string=None):
        ...
        if self.conv_template.name == 'llama-2':
            ...
            # BRASS: modern FastChat templates use the incremental slicing path (the char_to_token /
            # ``.system`` path below relies on a FastChat <=0.2.20 API that no longer exists).
