...
def load_model_and_tokenizer(model_path, tokenizer_path=None, device='cuda:0', **kwargs):
    ...
    tokenizer_path_lower = str(tokenizer_path).lower()  # BRASS_TAO_CASE_INSENSITIVE_MODEL_PATH
    ...
    # BRASS: GCG only needs gradients w.r.t. the one-hot input embeddings, not the model weights.
    # Freezing params avoids allocating grad buffers for all 32B parameters (large VRAM saving).
