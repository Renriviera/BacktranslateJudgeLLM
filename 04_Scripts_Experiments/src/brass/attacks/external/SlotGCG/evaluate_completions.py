...
import numpy as np
import transformers
from eval_utils import compute_results_advbench, compute_results_classifier, compute_results_hashing
...
def parse_args():
    ...
    parser.add_argument("--cls_path", type=str, default='/scratch/a1861a01/Jailbreak/Attack/LLM/HarmBench-Llama-2-13b-cls',
