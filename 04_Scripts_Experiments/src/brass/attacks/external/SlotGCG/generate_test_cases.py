...
def main():
    ...
    config_file = "configs/model_configs/models.yaml" if not args.models_config_file else args.models_config_file
    ...
    test_cases, logs = method.generate_test_cases(behaviors=behaviors, verbose=args.verbose, save_dir=save_dir, run_id=args.run_id)
