...
if __name__ == "__main__":
    ...
    with safetensors.safe_open(args.kohya_lora_path, framework="pt", device="cpu") as f:
        ...
        text_encoder_lora_state_dict = dict.fromkeys(get_peft_model_state_dict(text_encoder).keys())
        ...
        unet_lora_state_dict = dict.fromkeys(get_peft_model_state_dict(unet).keys())
