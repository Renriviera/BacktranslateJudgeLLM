...
``src/brass/metrics/judge_asr.py``: HuggingFace ``google/gemma-2b`` encode with default
...
GENERATION_MAX_TOKENS = 256  # configs/experiment/*_strongreject*.yaml sampling.max_tokens
