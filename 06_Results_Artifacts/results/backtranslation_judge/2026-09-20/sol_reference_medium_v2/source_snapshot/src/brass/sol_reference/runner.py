...
MODEL = "gpt-5.6-sol"
DEFAULT_PARENT = REPO / "results/backtranslation_judge/2026-09-20"
DEFAULT_OUT = DEFAULT_PARENT / "sol_reference_medium"
SOURCE_PATHS = [
    "src/brass/sol_reference/__init__.py",
    "src/brass/sol_reference/runner.py",
    "scripts/backtranslation_judge_sol.py",
