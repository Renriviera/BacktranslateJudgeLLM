...
export default function BacktranslationJudgeDesign() {
  ...
  return <Stack gap={18} style={{ padding: 24, maxWidth: 1120, color: theme.text.primary }}>
    ...
    <Text size="small" tone="secondary">These splits were generated with all attacks/siblings grouped and at least 23 previously reviewed behavior IDs held in development. MiniLM found no behavior pairs at cosine >=0.80; this is not a human certification of independence. Source: frozen groups.json, September 20, 2026.</Text>
