...
def reuse(source, destination):
    ...
    verified = []
    worker_changed = (
        old["source_sha256"]["src/brass/backtranslation_judge/runner.py"]
        != new["source_sha256"]["src/brass/backtranslation_judge/runner.py"]
    )
    for event in events.values():
        ...
        if kind in ("supported_inverse", "wang_inverse", "S-rubric", "E", "E-repeat", "H", "H+R"):
            ...
            worker = "src/brass/backtranslation_judge/runner.py"
